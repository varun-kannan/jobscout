...
import m007 from "./007_crawl.sql" with { type: "text" };
import m008 from "./008_liveness.sql" with { type: "text" };
...
export const MIGRATIONS: readonly Migration[] = [
  ...
  { version: 7, name: "crawl", sql: m007 },
  { version: 8, name: "liveness", sql: m008 },
];
